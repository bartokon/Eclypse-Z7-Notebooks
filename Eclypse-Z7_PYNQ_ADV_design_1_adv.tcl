...
#
# Eclypse-Z7_PYNQ_ADV_design_1_adv.tcl: Tcl script for re-creating project 'Eclypse-Z7_PYNQ_ADV'
#
# Generated by Vivado on Thu Oct 08 15:49:21 CEST 2020
...
#
# 1. This project restoration tcl script (Eclypse-Z7_PYNQ_ADV_design_1_adv.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/bartek/Eclypse-Z7_PYNQ_ADV/Eclypse-Z7_PYNQ_ADV.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#    "/home/bartek/Eclypse-Z7_PYNQ_ADV/Eclypse-Z7_PYNQ_ADV.srcs/constrs_1/imports/constraints/Eclypse-Z7-Master.xdc"
#
...
set _xil_proj_name_ "Eclypse-Z7_PYNQ_ADV"
...
set script_file "Eclypse-Z7_PYNQ_ADV_design_1_adv.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../Eclypse-Z7_PYNQ_ADV"]"
...
set files [list \
 [file normalize "${origin_dir}/../../Eclypse-Z7_PYNQ_ADV/Eclypse-Z7_PYNQ_ADV.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"]\
]
...
set file "[file normalize ${origin_dir}/../../Eclypse-Z7_PYNQ_ADV/Eclypse-Z7_PYNQ_ADV.srcs/constrs_1/imports/constraints/Eclypse-Z7-Master.xdc]"
...
proc cr_bd_design_1 { parentCell } {
  ...
  set btn1 [ create_bd_port -dir I -from 0 -to 0 btn1 ]
  ...
  set led1_b [ create_bd_port -dir O -from 0 -to 0 led1_b ]
  set led1_g [ create_bd_port -dir O -from 0 -to 0 led1_g ]
  set led1_r [ create_bd_port -dir O -from 0 -to 0 led1_r ]

  # Create instance: add_0, and set properties
  set add_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:add:1.0 add_0 ]

  # Create instance: addfloat_0, and set properties
  set addfloat_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:addfloat:1.0 addfloat_0 ]

  # Create instance: axi_dma_mult_constant, and set properties
  set axi_dma_mult_constant [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 axi_dma_mult_constant ]
  set_property -dict [ list \
   CONFIG.c_include_mm2s {1} \
   CONFIG.c_include_s2mm {1} \
   CONFIG.c_include_sg {0} \
   CONFIG.c_sg_include_stscntrl_strm {0} \
 ] $axi_dma_mult_constant
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_mult_constant/M_AXIS_MM2S] [get_bd_intf_pins mult_constant_0/in_data]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S [get_bd_intf_pins axi_dma_mult_constant/M_AXI_MM2S] [get_bd_intf_pins axi_smc/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM [get_bd_intf_pins axi_dma_mult_constant/M_AXI_S2MM] [get_bd_intf_pins axi_smc/S01_AXI]
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
  connect_bd_intf_net -intf_net mult_constant_0_out_data [get_bd_intf_pins axi_dma_mult_constant/S_AXIS_S2MM] [get_bd_intf_pins mult_constant_0/out_data]
  ...
  connect_bd_intf_net -intf_net ps7_smartaxi_peripherials_M05_AXI [get_bd_intf_pins addfloat_0/s_axi_AXILiteS] [get_bd_intf_pins ps7_smartaxi_peripherials/M05_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M02_AXI [get_bd_intf_pins axi_dma_mult_constant/S_AXI_LITE] [get_bd_intf_pins ps7_smartaxi_peripherials/M02_AXI]

  # Create port connections
  connect_bd_net -net In0_0_1 [get_bd_ports btn0] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net In1_0_1 [get_bd_ports btn1] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins axi_gpio_0/gpio2_io_o] [get_bd_pins xlslice_2/Din] [get_bd_pins xlslice_3/Din] [get_bd_pins xlslice_4/Din] [get_bd_pins xlslice_5/Din] [get_bd_pins xlslice_6/Din] [get_bd_pins xlslice_7/Din]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins add_0/ap_clk] [get_bd_pins addfloat_0/ap_clk] [get_bd_pins axi_dma_mult_constant/m_axi_mm2s_aclk] [get_bd_pins axi_dma_mult_constant/m_axi_s2mm_aclk] [get_bd_pins axi_dma_mult_constant/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins mult_constant_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_smartaxi_peripherials/aclk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins add_0/ap_rst_n] [get_bd_pins addfloat_0/ap_rst_n] [get_bd_pins axi_dma_mult_constant/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins mult_constant_0/ap_rst_n] [get_bd_pins ps7_smartaxi_peripherials/aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_ports led0_b] [get_bd_pins xlslice_2/Dout]
  connect_bd_net -net xlslice_3_Dout [get_bd_ports led0_g] [get_bd_pins xlslice_3/Dout]
  connect_bd_net -net xlslice_4_Dout [get_bd_ports led0_r] [get_bd_pins xlslice_4/Dout]
  connect_bd_net -net xlslice_5_Dout [get_bd_ports led1_b] [get_bd_pins xlslice_5/Dout]
  connect_bd_net -net xlslice_6_Dout [get_bd_ports led1_g] [get_bd_pins xlslice_6/Dout]
  connect_bd_net -net xlslice_7_Dout [get_bd_ports led1_r] [get_bd_pins xlslice_7/Dout]

  # Create address segments
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_mult_constant/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_mult_constant/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs addfloat_0/s_axi_AXILiteS/Reg] SEG_addfloat_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40400000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_dma_mult_constant/S_AXI_LITE/Reg] SEG_axi_dma_0_Reg
...
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 7 -x 2330 -y 360 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 7 -x 2330 -y 380 -defaultsOSRD
preplace portBus led1_b -pg 1 -lvl 7 -x 2330 -y 930 -defaultsOSRD
preplace portBus led0_r -pg 1 -lvl 7 -x 2330 -y 830 -defaultsOSRD
preplace portBus led0_g -pg 1 -lvl 7 -x 2330 -y 730 -defaultsOSRD
preplace portBus led0_b -pg 1 -lvl 7 -x 2330 -y 630 -defaultsOSRD
preplace portBus led1_g -pg 1 -lvl 7 -x 2330 -y 1030 -defaultsOSRD
preplace portBus led1_r -pg 1 -lvl 7 -x 2330 -y 1130 -defaultsOSRD
preplace portBus btn0 -pg 1 -lvl 0 -x -20 -y 930 -defaultsOSRD
preplace portBus btn1 -pg 1 -lvl 0 -x -20 -y 950 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 6 -x 2070 -y 410 -defaultsOSRD
preplace inst mult_constant_0 -pg 1 -lvl 3 -x 900 -y 460 -defaultsOSRD
preplace inst add_0 -pg 1 -lvl 3 -x 900 -y 80 -defaultsOSRD
preplace inst axi_dma_mult_constant -pg 1 -lvl 4 -x 1330 -y 420 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 5 -x 1680 -y 390 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -x 190 -y 590 -defaultsOSRD
preplace inst ps7_smartaxi_peripherials -pg 1 -lvl 2 -x 520 -y 370 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -x 900 -y 830 -defaultsOSRD
preplace inst axi_intc_0 -pg 1 -lvl 3 -x 900 -y 660 -defaultsOSRD
preplace inst xlslice_2 -pg 1 -lvl 6 -x 2070 -y 630 -defaultsOSRD
preplace inst xlslice_3 -pg 1 -lvl 6 -x 2070 -y 730 -defaultsOSRD
preplace inst xlslice_4 -pg 1 -lvl 6 -x 2070 -y 830 -defaultsOSRD
preplace inst xlslice_5 -pg 1 -lvl 6 -x 2070 -y 930 -defaultsOSRD
preplace inst xlslice_6 -pg 1 -lvl 6 -x 2070 -y 1030 -defaultsOSRD
preplace inst xlslice_7 -pg 1 -lvl 6 -x 2070 -y 1130 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 1 -x 190 -y 940 -defaultsOSRD
preplace inst addfloat_0 -pg 1 -lvl 3 -x 900 -y 220 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 7 0 370 370 260 700 550 1090 550 1530 580 1820 520 2300
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 7 10 490 NJ 490 670J 370 1080J 540 1520J 300 1830J 530 2290
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 4 370 480 710 560 1100 560 1540J
preplace netloc axi_intc_0_irq 1 3 3 NJ 670 NJ 670 1840
preplace netloc axi_gpio_0_ip2intc_irpt 1 2 2 730 930 1070
preplace netloc axi_gpio_0_gpio2_io_o 1 3 3 NJ 850 NJ 850 1850
preplace netloc xlslice_5_Dout 1 6 1 NJ 930
preplace netloc xlslice_4_Dout 1 6 1 NJ 830
preplace netloc xlslice_3_Dout 1 6 1 NJ 730
preplace netloc xlslice_2_Dout 1 6 1 NJ 630
preplace netloc xlslice_6_Dout 1 6 1 NJ 1030
preplace netloc xlslice_7_Dout 1 6 1 NJ 1130
preplace netloc In0_0_1 1 0 1 NJ 930
preplace netloc In1_0_1 1 0 1 NJ 950
preplace netloc xlconcat_0_dout 1 1 3 NJ 940 NJ 940 1090
preplace netloc axi_smc_M00_AXI 1 5 1 N 390
preplace netloc axi_dma_0_M_AXI_MM2S 1 4 1 N 360
preplace netloc smartconnect_0_M00_AXI 1 2 1 720 320n
preplace netloc processing_system7_0_DDR 1 6 1 NJ 360
preplace netloc mult_constant_0_out_data 1 3 1 1070 390n
preplace netloc smartconnect_0_M02_AXI 1 2 2 N 360 1090J
preplace netloc axi_dma_0_M_AXI_S2MM 1 4 1 N 380
preplace netloc ps7_smartaxi_peripherials_M04_AXI 1 2 1 660 400n
preplace netloc processing_system7_0_M_AXI_GP0 1 1 6 380 570 NJ 570 NJ 570 NJ 570 NJ 570 2310
preplace netloc ps7_smartaxi_peripherials_M03_AXI 1 2 1 680 380n
preplace netloc processing_system7_0_FIXED_IO 1 6 1 NJ 380
preplace netloc axi_dma_0_M_AXIS_MM2S 1 2 3 730 300 NJ 300 1510
preplace netloc smartconnect_0_M01_AXI 1 2 1 670 60n
preplace netloc ps7_smartaxi_peripherials_M05_AXI 1 2 1 690 200n
levelinfo -pg 1 -20 190 520 900 1330 1680 2070 2330
pagesize -pg 1 -db -bbox -sgen -140 0 2460 1290
"
}
